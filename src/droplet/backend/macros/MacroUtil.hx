package droplet.backend.macros;
...
/**
 * Some useful macro functions in a neat little class.
 * 
 * Some functions were taken from HaxeFlixel, credit to those devs!
 * @see https://github.com/HaxeFlixel/flixel/blob/master/flixel/system/macros/FlxMacroUtil.hx
 */
class MacroUtil {
	/**
